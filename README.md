...
This project also uses third-party components that are subject to their own licenses.  
For details on those components (e.g., fonts, Hugo Resume theme) and a full breakdown of licensing scopes, see the [NOTICE](./NOTICE) file.
